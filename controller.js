export const MSGS = {
    ...
    LEFT_VALUE_CHANGED: 'LEFT_VALUE_CHANGED',
    RIGHT_VALUE_CHANGED: 'RIGHT_VALUE_CHANGED',
};
...
export function leftValueChangedMsg(leftUnit) {
    return {
        type: MSGS.LEFT_VALUE_CHANGED,
        leftUnit,
    };
}

export function rightValueChangedMsg(rightUnit) {
    return {
        type: MSGS.RIGHT_VALUE_CHANGED,
        rightUnit,
    };
}
...
function update(msg, model) {
    switch (msg.type) {
        ...
        case MSGS.LEFT_VALUE_CHANGED: {
            const { leftUnit } = msg;
            return convert({ ...model, leftUnit });
        }
        case MSGS.RIGHT_VALUE_CHANGED: {
            const { rightUnit } = msg;
